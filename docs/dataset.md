...
# 数据集展示说明（自动由 Excel 生成）

本页基于你提供的 Excel（Sheet1）自动整理，汇总了 **46** 个与红外/多光谱相关的数据集条目（含任务类型、来源、链接与简介）。
...
- **字段说明**
  ...
  - **出处**：论文/会议/期刊或发布来源
  - **网址**：论文、项目页或数据集主页链接（若为空则表示 Excel 中未提供）
  - **描述**：Excel 中的原始简介（本页尽量保持不改写）
